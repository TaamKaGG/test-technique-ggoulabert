...
class RegistrationControllerTest extends WebTestCase
{
    ...
    private FighterRepository $userRepository;
    ...
    protected function setUp(): void
    {
        ...
        $this->userRepository = $container->get(FighterRepository::class);
    ...
    public function testRegister(): void
    {
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'guilhem.goulabert@gmail.com');
        ...
        self::assertTrue(static::getContainer()->get(FighterRepository::class)->findAll()[0]->isVerified());
    }
}
